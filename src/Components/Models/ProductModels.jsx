...
export default function ProductModels() {
  return (
    <section className="bg-[#3d0a21] py-20 md:py-28">
      <div className="container-stitch">
        <div className="mb-12 text-center">
          <p className="mb-4 type-label text-[#d4af37]">Collection Assets</p>
          <h2 className="type-section text-white">Product Models</h2>
        </div>
