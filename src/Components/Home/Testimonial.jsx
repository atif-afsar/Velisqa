...
export default function Testimonial() {
  return (
    <section className="bg-[#f9f5f0] py-24 text-center">
      <p className="mb-10 type-label text-[#d4af37]">Voices of Distinction</p>
      <blockquote className="mx-auto max-w-4xl type-quote text-[#3d0a21]">
      ...
      <p className="mt-8 type-label text-[#847377]">Sonia R., Architectural Designer</p>
