  ...
  return (
    <section className="bg-[#f9f5f0] py-24">
      <div className="container-stitch grid items-center gap-20 md:grid-cols-2">
        ...
        <div>
          <p className="mb-5 text-[10px] uppercase tracking-[0.35em] text-[#d4af37]">Our Heritage</p>
          <h2 className="font-serif text-5xl leading-tight text-[#130006]">A Legacy of<br />Brilliance</h2>
          <p className="mt-8 max-w-lg text-sm leading-7 text-[#514347]">
