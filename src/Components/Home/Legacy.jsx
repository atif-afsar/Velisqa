...
export default function Legacy() {
  return (
    <section className="bg-[#f9f5f0] py-16 md:py-24">
      <div className="container-stitch grid items-center gap-12 md:grid-cols-2 lg:gap-20">
        <div className="luxury-arch aspect-[4/5] overflow-hidden bg-[#ebe8e3] shadow-2xl">
          <img src={craftsmanship} alt="Jewellery craftsmanship" loading="lazy" decoding="async" className="h-full w-full object-cover" />
        </div>
        <div>
          ...
          <a href="#ethos" className="tap-target mt-10 inline-flex items-center border-b border-[#130006] pb-2 text-[11px] font-semibold uppercase tracking-[0.22em] text-[#130006]">Learn Our History</a>
        </div>
      </div>
    </section>
  );
