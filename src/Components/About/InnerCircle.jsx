export default function InnerCircle() {
  return (
    <section className="bg-[#fdf9f4] px-4 py-20 text-center md:py-28">
      <h2 className="type-section text-[#130006]">The Inner Circle</h2>
      ...
      <form className="mx-auto mt-10 flex max-w-xl flex-col gap-4 sm:flex-row">
        ...
        <button className="tap-target bg-[#130006] px-10 py-4 text-[11px] font-semibold uppercase tracking-[0.22em] text-white">Join</button>
      </form>
    </section>
  );
}
