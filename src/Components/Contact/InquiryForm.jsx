export default function InquiryForm() {
  ...
  return (
    <section className="bg-[#f7f3ee] p-8 shadow-[32px_32px_64px_-16px_rgba(19,0,6,0.04)] md:p-12 lg:col-span-8">
      <h2 className="mb-8 font-serif text-[40px] font-medium leading-[1.2] text-[#130006]">Bespoke Inquiry</h2>
      <form className="space-y-9">
        ...
        <div className="flex justify-end">
          <button className="bg-[#130006] px-12 py-4 label-stitch uppercase tracking-[0.2em] text-white transition hover:bg-[#b97189]" type="submit">
            Submit Inquiry
          </button>
        </div>
      </form>
