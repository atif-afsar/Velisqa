export default function Concierge() {
  return (
    <section id="contact" className="mx-auto mb-32 max-w-[900px] px-6 text-center">
      ...
      <form className="mb-8 flex flex-col items-end gap-8 md:flex-row">
      ...
      <div className="mx-auto max-w-[700px]">
        ...
        <div className="flex items-center justify-center">
          <a href={"https://wa.me/?text=" + encodeURIComponent("Hello VELISQA, I’d like private assistance with a purchase.")} target="_blank" rel="noreferrer" className="inline-flex items-center gap-3 rounded-full bg-[#130006] px-6 py-3 font-semibold text-[#ffe088] shadow-lg">Luxury Concierge via WhatsApp</a>
        </div>
      </div>
    </section>
  );
