...
export default function FloatingWhatsApp() {
  return (
    <div>
      <div className="pointer-events-none fixed inset-0 z-40 flex items-end justify-end p-6 md:p-12">
        ...
        >
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group relative flex items-center gap-3 rounded-full bg-[#10221a]/80 px-4 py-3 shadow-2xl backdrop-blur-md"
            aria-label="Contact VELISQA on WhatsApp"
          >
            <div className="absolute -inset-1 -z-10 rounded-full blur-lg bg-gradient-to-br from-[#1b1b18]/40 via-[#3a201e]/20 to-[#d4af37]/10 opacity-60 transition-opacity group-hover:opacity-100" />
      ...
      {/* Mobile sticky rounded button */}
      <div className="fixed bottom-6 left-1/2 z-50 flex w-full -translate-x-1/2 justify-center md:hidden">
        <a
          href={"https://wa.me/?text=" + encodeURIComponent("Hello VELISQA, I’m interested in a piece and would like private assistance.")}
          className="flex items-center gap-3 rounded-full bg-[#13231f] px-5 py-3 shadow-2xl"
          target="_blank"
          rel="noreferrer"
        >
          ...
          <span className="label-stitch text-sm text-[#ffe088]">Order via WhatsApp</span>
        </a>
      </div>
    </div>
  );
