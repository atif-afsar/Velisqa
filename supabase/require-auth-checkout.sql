-- Require sign-in before checkout. Run once in Supabase SQL Editor.
...
revoke execute on function public.create_manual_payment_order(jsonb, jsonb) from anon;
grant execute on function public.create_manual_payment_order(jsonb, jsonb) to authenticated;
